...
* Студент: [Анатолий Трофименко](https://up.htmlacademy.ru/htmlcss/22/user/601297).
* Наставник: `Дмитрий Кабанов`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/601297-sedona) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
